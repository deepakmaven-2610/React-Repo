...
export default function EventDetails() {
 ...
 const{mutate, isPending: isPendingDeletion, isError: isErrorDeleting, error:deleteError} = useMutation({
  ...
  {
    content = <div id="event-details-content" className='center'>
    <ErrorBlock title="Failed to load events" message={error.info?.message || 'Failed to fecth data please try again later' } />
    </div>
  }
  ...
  return (
    ...
    <Modal onClose={handleStopDelete}>
      <h2> Are you sure?</h2>
      <p> Do you really want to delete this, this cant be undone</p>
      <div className='form-actions'>
        {isPendingDeletion && <p> Deleting is in progress....</p>}
        {!isPendingDeletion && (
        <>
