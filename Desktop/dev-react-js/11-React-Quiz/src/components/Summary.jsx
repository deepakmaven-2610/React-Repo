    ...
    return (
        <div id="summary">
          ...
          <div id = "summary-stats">
            <p>
                <span className='numbers'>{skippedAnswerShare}%</span> <br/><br/>
                <span className='text'>Skipped</span>
            </p>
            <p>
                <span className='numbers'>{correctAnswerShare}%</span>  <br/><br/>
                <span className='text'>answered correctly</span>
            </p>
            <p>
                <span className='numbers'>{wrongAnswerShare}%</span>  <br/><br/>
