...
import { isEmail, isNotEmpty, hasMinLength, hasMaxLength, hasValidPasswordFormat } from '../util/validation.js';
...
export default function Login() {
  ...
  // const passwordIsInvalid =
  // didEdit.password &&
  // (!hasMinLength(enteredValues.password, 6) || !hasMaxLength(enteredValues.password, 16));
  const passwordIsInvalid =
  didEdit.password &&
